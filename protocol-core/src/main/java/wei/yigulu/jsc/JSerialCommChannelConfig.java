...
public interface JSerialCommChannelConfig extends ChannelConfig {
    ...
    enum Databits {
         ...
         */
        DATABITS_5(purejavacomm.SerialPort.DATABITS_5),
        /**
         * 6 data bits will be used for each character
         */
        DATABITS_6(purejavacomm.SerialPort.DATABITS_6),
        /**
         * 7 data bits will be used for each character (ie. ASCII)
         */
        DATABITS_7(purejavacomm.SerialPort.DATABITS_7),
        /**
         * 8 data bits will be used for each character (ie. binary data)
         */
        DATABITS_8(purejavacomm.SerialPort.DATABITS_8);
        ...
        public static Databits valueOf(int value) {
            ...
            throw new IllegalArgumentException("unknown " + PureJavaCommChannelConfig.Databits.class.getSimpleName() + " value: " + value);
        }
    }
     ...
     */
    JSerialCommChannelConfig setDatabits(Databits databits);
